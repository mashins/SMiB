...
public class PathFinding
{
    ...
    public void DisableConnection(Vector2Int cell1, Vector2Int cell2)
    {
        DisableConnection(cells[cell1.x, cell1.y], cells[cell2.x, cell2.y]);
    }

    private void DisableConnection(Cell cell1, Cell cell2)
    {
        for (int i = 0; i < 4; i++)
        {
            if (cell1.neighbours[i] == cell2)
            {
                cell1.neighbours[i] = null;
            }
            if (cell2.neighbours[i] == cell1)
            {
